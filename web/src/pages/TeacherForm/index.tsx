...
const TeacherForm: React.FC = () => {
  ...
  function handleCreateClass(e: FormEvent) {
    ...
    .catch(() => alert('Erro no cadastro... tente novamente em alguns instantes'));
  }

  function setScheduleItemValue(index: number, field: string, value: string) {
    const newArray = scheduleItems.map((scheduleItem, i) => {
      return (i === index) ? { ...scheduleItem, [field]: value } : {...scheduleItem};
    });
              ...
              scheduleItems.map((scheduleItem, index) => {
                return (
                  <div key={index} className="schedule-item">
                    ...
                    />
                    <Input name={scheduleItem.from} label="Das" type="time" 
